...
// */
//public class OvidIDSampler extends AbstractJavaSamplerClient implements Serializable {
...
//
//        synchronized (OvidIDSampler.class) {
//            if (solrClient == null) {
//                try {
...
//        termsQ.add("terms.fl", "id");
//        termsQ.setParam("terms.limit", "10000");
//        QueryResponse resp = solrClient.query(collection, termsQ);
//        List<TermsResponse.Term> terms = resp.getTermsResponse().getTermMap().get("id");
